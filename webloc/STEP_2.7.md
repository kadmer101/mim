...
<div class="min-h-screen bg-gray-50 py-8" dir="{{ app()->getLocale() === 'ar' ? 'rtl' : 'ltr' }}">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3 {{ app()->getLocale() === 'ar' ? 'space-x-reverse' : '' }}">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 md:ml-2 text-sm font-medium text-gray-500 {{ app()->getLocale() === 'ar' ? 'mr-1 md:mr-2 ml-0' : '' }}">{{ __('Components') }}</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 mb-8">
            <div class="px-6 py-8 sm:px-8">
                <h1 class="text-3xl font-bold text-gray-900 mb-4">
                    {{ __('WebBloc Components') }}
                </h1>
                <p class="text-lg text-gray-600">
                    {{ __('Complete reference for all available WebBloc components and their configuration options.') }}
                </p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 sticky top-8">
                    <nav class="space-y-2">
                        <a href="#auth-component" class="block text-sm font-medium text-indigo-600 bg-indigo-50 rounded-md px-3 py-2">
                            {{ __('Authentication') }}
                        </a>
                        <a href="#comments-component" class="block text-sm text-gray-700 hover:text-indigo-600 hover:bg-gray-50 rounded-md px-3 py-2">
                            {{ __('Comments') }}
                        </a>
                        <a href="#reviews-component" class="block text-sm text-gray-700 hover:text-indigo-600 hover:bg-gray-50 rounded-md px-3 py-2">
                            {{ __('Reviews') }}
                        </a>
                        <a href="#contact-component" class="block text-sm text-gray-700 hover:text-indigo-600 hover:bg-gray-50 rounded-md px-3 py-2">
                            {{ __('Contact Form') }}
                        </a>
                        <a href="#newsletter-component" class="block text-sm text-gray-700 hover:text-indigo-600 hover:bg-gray-50 rounded-md px-3 py-2">
                            {{ __('Newsletter') }}
                        </a>
                        <a href="#testimonials-component" class="block text-sm text-gray-700 hover:text-indigo-600 hover:bg-gray-50 rounded-md px-3 py-2">
                            {{ __('Testimonials') }}
                        </a>
                    </nav>
                </div>
            ...
            <div class="lg:col-span-3 space-y-8">
                <!-- Authentication Component -->
                <div id="auth-component" class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                    <div class="flex items-center mb-6">
                        <div class="w-10 h-10 bg-indigo-100 rounded-lg flex items-center justify-center mr-4 {{ app()->getLocale() === 'ar' ? 'ml-4 mr-0' : '' }}">
                            <svg class="w-6 h-6 text-indigo-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                            </svg>
                        </div>
                        <div>
                            <h2 class="text-2xl font-semibold text-gray-900">{{ __('Authentication Component') }}</h2>
                            <p class="text-sm text-gray-500">data-webbloc="auth"</p>
                        </div>
                    </div>

                    <p class="text-gray-600 mb-6">
                        {{ __('Complete user authentication system with login, registration, password reset, and profile management functionality.') }}
                    </p>

                    <div class="space-y-6">
                        <!-- Basic Usage -->
                        <div>
                            <h3 class="text-lg font-medium text-gray-900 mb-3">{{ __('Basic Usage') }}</h3>
                            <div class="bg-gray-900 rounded-lg p-4 overflow-x-auto">
                                <pre class="text-green-400 text-sm"><code>&lt;div data-webbloc="auth"&gt;
    {{ __('Loading authentication...') }}
&lt;/div&gt;</code></pre>
                            </div>
                        </div>
                        ...
                        <div>
                            <h3 class="text-lg font-medium text-gray-900 mb-3">{{ __('Configuration Options') }}</h3>
                            <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
                                <table class="min-w-full divide-y divide-gray-300">
                                    <thead class="bg-gray-50">
                                        <tr>
                                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{{ __('Attribute') }}</th>
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        <tr>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">data-theme</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">string</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">light</td>
                                            <td class="px-6 py-4 text-sm text-gray-500">{{ __('Theme style: light, dark') }}</td>
                                        </tr>
                                        <tr>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">data-locale</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">string</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">en</td>
                                            <td class="px-6 py-4 text-sm text-gray-500">{{ __('Language: en, ar') }}</td>
                                        </tr>
                                        <tr>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">data-redirect</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">string</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">null</td>
                                            <td class="px-6 py-4 text-sm text-gray-500">{{ __('Redirect URL after login') }}</td>
                                        </tr>
                                        <tr>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">data-show-social</td>
                        ...
                        <!-- Advanced Example -->
                        <div>
                            <h3 class="text-lg font-medium text-gray-900 mb-3">{{ __('Advanced Configuration') }}</h3>
                            <div class="bg-gray-900 rounded-lg p-4 overflow-x-auto">
                                <pre class="text-green-400 text-sm"><code>&lt;div data-webbloc="auth" 
     data-theme="dark"
     data-locale="ar"
...
&lt;/div&gt;</code></pre>
                        ...
                        <!-- API Endpoints -->
                        <div>
                            <h3 class="text-lg font-medium text-gray-900 mb-3">{{ __('Related API Endpoints') }}</h3>
                            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                                <ul class="text-sm text-blue-800 space-y-1">
                                    <li><code>POST /api/auth/register</code> - {{ __('User registration') }}</li>
                                    <li><code>POST /api/auth/login</code> - {{ __('User login') }}</li>
                                    <li><code>POST /api/auth/logout</code> - {{ __('User logout') }}</li>
                                    <li><code>GET /api/auth/user</code> - {{ __('Get current user') }}</li>
                                    <li><code>PUT /api/auth/profile</code> - {{ __('Update profile') }}</li>
                                    <li><code>POST /api/auth/forgot-password</code> - {{ __('Password reset') }}</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <!-- Comments Component -->
                <div id="comments-component" class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                    <div class="flex items-center mb-6">
                        <div class="w-10 h-10 bg-green-100 rounded-lg flex items-center justify-center mr-4 {{ app()->getLocale() === 'ar' ? 'ml-4 mr-0' : '' }}">
                            <svg class="w-6 h-6 text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 
